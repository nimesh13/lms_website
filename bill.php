...
session_start();
$usr = $_SESSION['user'];
		$sql = mysql_query("SELECT timestampdiff(second,start,stop) AS diff FROM labour WHERE regno=$usr");
		mysql_query("UPDATE labour SET start=null, stop=null WHERE regno=$usr");
