...
if(isset($_POST['signup']))
{
    ...
    $regno = mysql_real_escape_string($_POST['customerregistrationnumber']);
    $pwd = md5(mysql_real_escape_string($_POST['password']));


    if(mysql_query("INSERT INTO customer(name,city, pwd, regno) VALUES('$name', '$city','$pwd', '$regno')"))
    {
		session_start();
	$_SESSION['user'] = $regno;
...
if (isset($_POST['submit4']))
    ...
    $res = mysql_query("SELECT * FROM customer WHERE regno='$regno'");
...
<!DOCTYPE html>
<html>
<head> <title>CUSTOMERS | CL Inc.></title>
