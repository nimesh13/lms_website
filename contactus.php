...
if(isset($_POST['send']))
{
    $cregno = mysql_real_escape_string($_POST['cregnumber']);
    $qry = mysql_real_escape_string($_POST['query']);
	$wregno = mysql_real_escape_string($_POST['wregnumber']);
	$rating = mysql_real_escape_string($_POST['rating']);

    if(mysql_query("INSERT INTO query(cregno, qry, wregno, rating) VALUES('$cregno', '$qry', '$wregno', '$rating')"))
    {
